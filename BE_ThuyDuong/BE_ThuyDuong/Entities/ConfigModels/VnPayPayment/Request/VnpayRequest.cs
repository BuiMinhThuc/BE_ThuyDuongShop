...
using BE_ThuyDuong.ConfigModels.VnPayPayment.Lib;
using BE_ThuyDuong.ConfigModels.VnPayPayment.Response;



namespace BE_ThuyDuong.ConfigModels.VnPayPayment.Request
{
    public class VnpayRequest
    {
        ...
        public string GetLink(string baseUrl, string secretKey)
        {
            ...
            var secureHash = HashHelpers.HmacSHA512(secretKey, data.ToString().Remove(data.Length - 1, 1));
